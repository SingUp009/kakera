...
import { useMosaicEngine } from "@/features/mosaic/hooks/useMosaicEngine";
...
export function MosaicApp() {
  const { loadTiles, render, progress, busy } = useMosaicEngine();
  ...
  // Signature of the index currently loaded on the Rust side.
